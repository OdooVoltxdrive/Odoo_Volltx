...
class WizardReport_2(models.TransientModel): # aqui declaro las variables del wizar que se usaran para el filtro del pdf
    ...
    def get_invoice(self):
        ...
        for det in cursor_resumen:
            ...
            if det.invoice_id.move_type=="in_invoice" or det.invoice_id.move_type=="in_refund":
	            for det_line in det.lines_id:
	                ...
	                'code':det_line.code,
	                'abono_cta':abs(det.invoice_id.amount_total_signed), #abs(det.invoice_id.amount_total_signed),
    ...
    def print_resumen_islr(self):
        ...
        return self.env.ref('resumen_retenciones.action_resumen_islr_report').report_action(self)
