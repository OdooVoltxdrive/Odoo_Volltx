    ...
    def create_xml(self):
        ...
        for item in retencion:
            for line in item.lines_id:
                ...
                nro_fact=item.invoice_id.invoice_number_next.replace('-', '')
                ...
                elemento_hijo_4 = ET.SubElement(elemento_hijo_1, 'NumeroControl').text=str(item.invoice_id.invoice_number_control.replace('-', ''))
